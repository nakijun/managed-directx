...
namespace Xtro.MDX.Utilities
{
    public sealed class DialogResourceManager
    {
        ...
        int CreateFont(uint Font)
        {
            ...
            var Result = D3DX10Functions.CreateFont(Device, FontNode[0].Height, 0, (uint)FontNode[0].Weight, 1, false, FontCharacterSet.Default, FontPrecision.Default, FontQuality.Default, FontPitchAndFamilyFlag.Default | FontPitchAndFamilyFlag.DontCare, FontNode[0].Face, out FontNode[0].Font);
