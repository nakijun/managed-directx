...
namespace DXGI
{
	...
	public:
		...
		SwapChainDescription(ModeDescription BufferDescription, Xtro::MDX::DXGI::SampleDescription SampleDescription, Usage BufferUsage, int BufferCount, IntPtr OutputWindow, bool Windowed, Xtro::MDX::DXGI::SwapEffect SwapEffect, SwapChainFlag Flags)
		{
