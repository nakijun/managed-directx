...
public:
	...
	static int Trace(String^ File, unsigned long Line, int Result, String^ Message, bool PopMessageBox)
	{
	...
	static int TraceMessage(String^ File, unsigned long Line, String^ String)
	{
		return Trace(File, Line, 0, String, false);
	}

	static int TraceError(String^ File, unsigned long Line, String^ String, int Result)
	{
		return Trace(File, Line, Result, String, false);
	}

	static int TraceErrorMessageBox(String^ File, unsigned long Line, String^ String, int Result)
	{
